...
export class News extends Component {
  ...
  async componentDidMount() {
    let headlinesUrl = !this.props.selectnews
      ? "https://newsapi.org/v2/everything?q=tesla&from=2022-08-09&sortBy=publishedAt&apiKey=0353104df37b4cd982f89b2ff237063b"
